...
describe('SERVER_ROUTE_MANIFEST — derivation provenance', () => {
  it('is derived from phlix-server master 8a90e20e (s81 profiles + cs13 hub-link included)', () => {
    ...
    expect(SERVER_ROUTE_MANIFEST_PROVENANCE.serverSha).toBe(
      '8a90e20ef5b9eb5735e5c461f08a180f4a4d64b5',
    );
  });
...
describe('the committed dist/server-route-manifest.json artifact', () => {
  ...
  const CS22_MANIFEST_MD5 = '7dee0d22097b98609f7c288e4a482d4d';
